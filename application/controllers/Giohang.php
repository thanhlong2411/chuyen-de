...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='HDMOBILE - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='HDMOBILE - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Hệ thống HDMOBILE');
        ...
        $this->data['title']='HDMOBILE - Kết quả đơn hàng';
