<section class="logo-search" style="height: 125px;background: #FFF;">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/logohdmobile.jpg" alt="Logo Construction"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 search"style="margin-top: 40px;">
      <form action="search" method="get" role="form"style="margin-right: -40px;">
        <div class="input-search">
          <input type="text" class="form-control" id="search_text" name="search" placeholder="Nhập từ khóa để tìm kiếm...">
          <button style="background: #C44027;">
      ...
      <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12 hidden-xs" style="padding: 24px;">
       <!-- Cart -->
   ...
   <div class="user_login">
     <a href="thong-tin-khach-hang" title="Tài khoản">
      <div class="user_login_icon">
       <img src="<?php echo base_url() ?>public/images/user1.png" alt="Cart">
     </div>
     <div class="box_text">
 ...
 <div class="user_login">
     <a href="thong-tin-khach-hang" title="Tài khoản">
      <div class="user_login_icon">
       <img src="<?php echo base_url() ?>public/images/phone-call.png" alt="Cart">
     </div>
     <div class="box_text ">
       <strong style="width: 95px;margin-top: -7px;">Gọi Mua Hàng <p style="font-weight: lighter;">0348957339</p></strong>
       <!--<span class="cart_price">Đăng nhập, đăng ký</span>-->
     </div>
   </a>
 </div>
