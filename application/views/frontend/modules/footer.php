    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logohdmobile.jpg" style="width: 100%;" class="img-fix f-logo" alt="smart-construction">
                </a>
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>234 Nguyễn Trãi, Thành Phố Huế</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0933064777 - 0975470777</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:thanhlong2411@gmail.com">thanhlong2411@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
